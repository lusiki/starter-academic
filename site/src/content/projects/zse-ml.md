...
title_hr: "Predviđanje prinosa na tankim tržištima — strojno učenje na Zagrebačkoj burzi"
...
body_hr: >-
  Interaktivna popratna stranica rada "Predviđanje prinosa na tankim tržištima:
  pristup strojnog učenja Zagrebačkoj burzi" (Mislav Šagovac, Luka Šikić i Petra
  Palić). Projekt iz 24 godine dnevnih OHLCV podataka (2000.–2024.) izvodi više
  od 1.100 prediktora — tehničke pokazatelje, značajke vremenskih serija i
  valićne dekompozicije — te uspoređuje Elastic Net, Random Forest, XGBoost i
  plitku neuronsku mrežu u ugniježđenoj pomičnoj validaciji. Točnost smjera
  iznosi 46–53 %, nelinearni modeli nadmašuju linearni, a rezultati pokazuju
  izražen gradijent likvidnosti, uz ograničenja transakcijskih troškova kod
  najmanje likvidnih dionica.
date: 2025-01-01
tags:
  - "machine learning"
  - "finance"
